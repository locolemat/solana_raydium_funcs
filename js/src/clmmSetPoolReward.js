...
function clmmSetPoolReward(input) {
    return __awaiter(this, void 0, void 0, function* () {
        // -------- pre-action: fetch basic info --------
        const clmmPool = yield (0, formatClmmKeysById_1.formatClmmKeysById)(input.targetPool);
        // -------- step 1: clmm info  --------
        const { [clmmPool.id]: { state: clmmPoolInfo } } = yield raydium_sdk_1.Clmm.fetchMultiplePoolInfos({
        ...
        const makeSetRewardsInstruction = yield raydium_sdk_1.Clmm.makeSetRewardsInstructionSimple({
            connection: config_1.connection,
        ...
        return { txids: yield (0, util_1.buildAndSendTx)(makeSetRewardsInstruction.innerTransactions) };
    });
}
function howToUse() {
    return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=clmmSetPoolReward.js.map